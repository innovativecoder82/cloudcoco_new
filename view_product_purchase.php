...
<?php headertemplate(); ?>
  ...
  <body class="">
    <div class="page">
      <div class="flex-fill">
       <?php navbar('view_product_purchase'); ?>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">View Product Purchase</h3>
...
if(($adsessrole=='Admin')or($adsessrole=='Purchase Manager')or($adsessrole=='Accountant')or($adsessrole=='Driver')or($adsessrole=='Dailywage'))
		 ...
		 if (isset($_POST['submit'])) {
				...
				?>
                        <tr>
						  <td class="text-right">
                         <!--   <a href="edit_product_purchase.php?id=<?php echo $rowa['id'];?>" class="btn btn-secondary btn-sm">Edit</a> -->
                            <a href="view_product_purchase.php?id=<?php echo $rowa['id'];?>" class="btn btn-secondary btn-sm">Delete</a>
                          </td>

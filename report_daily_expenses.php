...
<?php headertemplate(); ?>
  ...
  <body class="">
    <div class="page">
      <div class="flex-fill">
       <?php navbar('report_daily_expenses'); ?>
        <div class="my-3 my-md-5">
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">View Daily Expenses - <div class="btn-group pull-right">
           
			<div class="control-group">
				<div class="controls" style="color:red;">
				   <form method="post" action="export.php" class="card">
                <button type="submit" name="daily_expenses" class="btn btn-primary ml-auto">Export</button>
			   </form>
				</div>
			</div>
		             </div></h3>
		 ...
		 <div class="col-auto ml-auto d-print-none">
                ...
                <a href="#" class="btn btn-primary ml-3 d-none d-sm-inline-block">
                   Total Expenses : Rs. <?php echo $tot_expenses; ?>
                </a>
                </a>
              </div>
              </div>

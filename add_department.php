...
if(isset($submit)){
	...
	$date = date('Y-m-d');
	$time = date('h:i sa');
	$query = mysqli_query($conn,"INSERT INTO department (department, date) VALUES('$department','$date')");
	
	echo'<script>alert("Successfully Added..!");window.location.href="view_department.php";</script>';
}
?>
<!doctype html>
					  ...
					  <div class="col-md-6 col-xl-12">
						<div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" name="department" class="form-control" autofocus autocomplete="off" required/>
                          </div>
                        </div>
                      </div>

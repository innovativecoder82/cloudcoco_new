...
if(isset($submit)){
	...
	$date = date('Y-m-d');
	$time = date('h:i sa');
	$query = mysqli_query($conn,"INSERT INTO  daily_expenses (expenses_details, exp_date, amount, paid_status, paid_through, account_holder, account_details, status, date) VALUES('$expenses_details','$exp_date','$amount','$paid_status','$paid_through','$account_holder','$account_details','Pending','$date')");
	
	echo'<script>alert("Successfully Added..!");window.location.href="add_daily_expenses.php";</script>';
}
?>
<!doctype html>
...
<?php headertemplate(); ?>
  ...
  <body class="">
                     ...
                     <div class="col-xl-4">
                      <div class="row">	
                        ...
                        <div class="mb-3">
                          ...
                          <textarea class="form-control" name="expenses_details" data-toggle="autosize" placeholder="Expenses Details"></textarea>
                        </div>
                      </div> 
					<div class="col-md-6 col-xl-12">
                      <div class="mb-3">
	...
	?>
						<label class="form-label">Date<span class="form-required">*</span></label>
                              ...
                              <input id="calendar-simple" name="exp_date" type="date" min="<?php echo $date; ?>" value="<?php echo $date; ?>" class="form-control mb-2" placeholder="Select a date" required />
                    ...
                    <div class="row">
						...
						<div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" name="paid_status" class="form-control" autocomplete="off" required/>
                          </div>
                        </div>
                      </div>					  
					  <div class="col-md-6 col-xl-12">
                    ...
                    <div class="row">
						...
						<div class="mb-3">
                          <div class="mb-3">
                            ...
                            <input type="text" name="account_holder" class="form-control" autocomplete="off" required/>
                          </div>
                        </div>
                      </div>
					<div class="col-md-6 col-xl-12">
                        <div class="mb-3">
                          ...
                          <textarea class="form-control" name="account_details" data-toggle="autosize" placeholder="Account Details"></textarea>
                        </div>
                      </div>
  ...
  <div class="d-flex">
    <a href="add_daily_expenses.php" class="btn btn-link">Cancel</a>
